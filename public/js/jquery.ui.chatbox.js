    ...
    $.widget("ui.chatbox", {
        ...
        toggleContent: function(event) {
            ...
            if (this.uiChatboxContent.is(":visible")) {
                 $.cookie('chat_est','maximizado', { path: '/' });
                 this.uiChatboxInputBox.focus();
            }else{
                 $.cookie('chat_est','minimizado', { path: '/' });
            }
        },
        widget: function() {
        ...
        _create: function() {
            ...
            uiChatboxTitlebar = (self.uiChatboxTitlebar = $('<div></div>'))
                ...
                .appendTo(uiChatbox),
            uiChatboxTitle = (self.uiChatboxTitle = $('<span style="color:#FFF"></span>'))
                .html(title)
                .appendTo(uiChatboxTitlebar),
            uiChatboxTitlebarClose = (self.uiChatboxTitlebarClose = $('<a href="#" style="height:20px;width:20px"></a>'))
            ...
            uiChatboxTitlebarMinimize = (self.uiChatboxTitlebarMinimize = $('<a href="#" style="height:20px;width:20px"></a>'))
                .addClass('ui-corner-all ' +
                          'ui-chatbox-icon'
                         )
                .attr('role', 'button')
