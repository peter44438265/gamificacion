...
(function ($) {
    ...
    $.flagStrap = function (element, options, i) {
        ...
        plugin.init = function () {
            ...
            if (plugin.settings.onSelect !== undefined && plugin.settings.onSelect instanceof Function) {
                $(htmlSelect).change(function (event) {
                    var element = this;
                    //alert("entro:"+$(element).attr("for"))
                    //alert("entro3:"+$('option:selected', element).text())
                    
                    options.onSelect($(element).attr("for"), element);
                });
            }
        ...
        var buildHtmlSelect = function () {
            var htmlSelectElement = $('<select/>').attr('for',plugin.settings.selectedCountry).attr('id', htmlSelectId).attr('name', plugin.settings.inputName);
            ...
            $(htmlSelect).find('option').each(function () {
                ...
                var flagStrapItem = $('<a/>')
                    ...
                    .on('click', function (e) {
                        ...
                        $(htmlSelect).attr('for', $(this).data('val'));
